    ...
    return (
        <div className='page-members'>
            <section className='project-owners'>
                ...
                <div className='cards-container'>
                    <div className='cards-wrapper'>
                        <MemberCard name="Matheus" description="UM EXÍMIO GAROTO DE PROGRAMA" job="DONO DO PROJETO" image="https://imgur.com/btE03lj.png" />
                        <MemberCard name="Rivas" description="NÃO VIRE PROGRAMADOR" job="LÍDER DE FRONT-END" image="https://imgur.com/WG97vq0.png" />
            ...
            <section className='project-employees'>
                ...
                <div className='cards-container'>
                    <div className='cards-wrapper'>
                        <MemberCard name="Marcus Vinicius " description="VOCÊ NÃO É CSS MAS É PURO ESTILO" job="desenvolverdor Front-End" image="https://imgur.com/3nHLNG5.png" />
                        ...
                        <MemberCard name="Pedro Marabisa" description="MALANDRO É MALANDRO , MANÉ É MANÉ" job="desenvolverdor Back-end" image="https://imgur.com/VE2oFMy.png" />
                        <MemberCard name="Guilherme Faglioni" description="NO MUNDO SE SEPARA OS SERES EM DOIS TIPOS:OS AVESTRUZES E OS NÃO-AVESTRUZES" job="desenvolvedor back-end" image="https://imgur.com/ZAYDDDV.png" />
